...
// Mobile Fields
    ...
    update_field('equipment_type',$equ_type,$post_id);
    update_field('equipment_storage',$equ_storage,$post_id);
    update_field('equipment_payment_type',$equ_payment_type,$post_id);
